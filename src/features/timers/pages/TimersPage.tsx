...
import { DEFAULT_TIMER_PRESETS } from '../../../core/models/TimerCombination';
import { TimerService } from '../../../core/services/TimerService';

export const TimersPage: React.FC = () => {
    const { timers, activeTimer, setActiveTimer, startTimer, pauseTimer, resetTimer, deleteTimer, createTimer } = useTimers();
            ...
            >
                <Stack spacing={2}>
                    ...
                    <AppButton
                        fullWidth
                        variant="outlined"
                        onClick={handleCreateLongPomodoro}
                    >
                        <Box sx={{ textAlign: 'left', width: '100%' }}>
                            <Typography variant="subtitle1" sx={{ fontWeight: 600 }}>
                                Long Pomodoro
