    ...
    >
      ...
      >
        ...
        >
                ...
                >
                  ...
                  {isActive && (
                    ...
                    >
                      ...
                      {(originalDuration % 60).toString().padStart(2, '0')}
                    </Typography>
                  )}
                </Box>
              </Box>
          ...
          >
            <Box
              sx={{ display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: 0.5 }}
            >
              <Typography
                variant="h6"
                sx={{
        ...
        <Box sx={{ px: 3, pb: 3, position: 'relative', zIndex: 1 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1 }}>
            {timer.status === TimerStatus.COMPLETED ? (
              ...
              >
                <Typography sx={{ color: 'white', fontWeight: 600 }}>Archive</Typography>
              </Box>
            ) : (
              <Box
              ...
              >
                {isRunning ? (
                  <PauseIcon sx={{ color: 'white', mr: 0.5 }} />
                ) : (
